...
def sample_ppo_representation_params(trial):
    """
    Sampler for the custom PPORepresentation hyperparams.
    ...
    return {
        ...
        'representation_coef': representation_coef,
        'rollout_history_size': rollout_history_size
...
HYPERPARAMS_SAMPLER = {
    ...
    'ppo_representation': sample_ppo_representation_params
}
